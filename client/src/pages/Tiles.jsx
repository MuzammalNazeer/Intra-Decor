...
const SUBCATEGORIES = ['All', 'Marble', 'Terrazzo', 'Glass', 'Travertine', 'Slate'];
...
export default function Tiles() {
  ...
  useEffect(() => {
    setLoading(true);
    let url = '/api/products?category=Tiles';
    if (selectedSub !== 'All') {
  ...
  return (
    <div className="min-h-screen bg-[#f7f4f0] pb-20">
      ...
      {/* ── HERO BANNER ── */}
      <div className="bg-gradient-to-r from-[#4b2c2c] via-[#7a4040] to-[#2c1a1a] text-white py-16 px-4 text-center relative overflow-hidden">
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <p className="text-sm text-gray-200 leading-relaxed max-w-xl mx-auto">
            Discover imported Italian porcelain, polished Venetian terrazzo, natural slate, and decorative glass mosaics for floors and walls.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        <div className="flex items-center justify-between mb-6">
          <span className="text-xs text-gray-500 font-medium">
            Showing <strong className="text-[#4b2c2c]">{products.length}</strong> porcelain & stone designs
          </span>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-white rounded-3xl border border-brand-border p-8">
            <p className="text-gray-500 text-sm mb-4">No tiles found matching your selected criteria.</p>
            <button
